...
<div class="w-full max-w-6xl">
    <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center"><x-icon name="qr_code" size="32px" class="mr-2" />Scan QR Kehadiran</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        {{-- RIGHT COLUMN: Manual Input / Scanner Gun --}}
